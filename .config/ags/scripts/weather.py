...
class weather_class:
    ...
    #10d:rain ,
    #13d: snow 
    # 50d: unclear weather/atmosphere conditions / mist
    #01d: sunshin /clear sky
    # 01n: moon 
    # 03* scattered clouds 
    # 04*;overcast
    #11d thunderstorm,  
    ...
    def set_temp(self):
        ...
        #0 temp, 1 feels like, 2 min, 3 max, 4 sunrise, 5 sunset, 6 icon
        return [self.temp,self.feels_like,self.min_tmp,self.max_tmp,self.sunrise,self.sunset,self.icon_dict[self.icon]]

    #get the important data from the json
    ...
    def getwheather_json(self,key,long,lat):
        ...
        #this function will print the json to the terminal in a specific format
    ...
    def set_key(self):
        ...
        with open(home_dir + '/.config/.keys', 'r') as file:
             for line in file:
